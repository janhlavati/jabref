...
* Fixed an issue where creating a custom entry type with an existing name (e.g., "Book") would overwrite standard types. [#15074](https://github.com/JabRef/jabref/pull/YOUR_PR_NUMBER_HERE)
